...
async def test_get(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.redirects.get(site_id="580e63e98c9a982ac9b8b741")
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.redirects.get(site_id="580e63e98c9a982ac9b8b741")
...
async def test_delete(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.redirects.delete(site_id="580e63e98c9a982ac9b8b741", redirect_id="66c4cb9a20cac35ed19500e6")
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.redirects.delete(
...
async def test_patch(client: Webflow, async_client: AsyncWebflow) -> None:
    expected_response: typing.Any = {"id": "42e1a2b7aa1a13f768a0042a", "fromUrl": "/mostly-harmless", "toUrl": "/earth"}
    expected_types: typing.Any = {"id": None, "fromUrl": None, "toUrl": None}
    response = client.redirects.patch(
    ...
    async_response = await async_client.redirects.patch(
        site_id="580e63e98c9a982ac9b8b741",
        redirect_id="66c4cb9a20cac35ed19500e6",
        id="42e1a2b7aa1a13f768a0042a",
        from_url="/mostly-harmless",

...
from webflow import TextNode
from webflow import Select
from webflow import SelectNodeWriteChoicesItem
from webflow import TextInput
from webflow import SubmitButton
from webflow import ComponentInstance
...
async def test_list_(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.components.list(site_id="580e63e98c9a982ac9b8b741", branch_id="68026fa68ef6dc744c75b833")
    validate_response(response, expected_response, expected_types)

    async_response = await async_client.components.list(
        site_id="580e63e98c9a982ac9b8b741", branch_id="68026fa68ef6dc744c75b833"
    )
...
async def test_update_content(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.components.update_content(
        ...
        nodes=[
            ...
            TextInput(node_id="a245c12d-995b-55ee-5ec7-aa36a6cad642", placeholder="Enter something here..."),
            SubmitButton(node_id="a245c12d-995b-55ee-5ec7-aa36a6cad671", value="Submit", waiting_text="Submitting..."),
            ComponentInstance(

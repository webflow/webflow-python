    ...
    expected_response: typing.Any = {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "propertyOverrides": [
                    {"propertyId": "a245c12d-995b-55ee-5ec7-aa36a6cad633", "type": "Plain Text"},
                    {"propertyId": "a245c12d-995b-55ee-5ec7-aa36a6cad635", "type": "Rich Text"},
                ],
            },
        ],
...
async def test_get_properties(client: Webflow, async_client: AsyncWebflow) -> None:
    expected_response: typing.Any = {
        ...
        "properties": [
            {"propertyId": "a245c12d-995b-55ee-5ec7-aa36a6cad623", "type": "Plain Text", "label": "Title"},
            {"propertyId": "a245c12d-995b-55ee-5ec7-aa36a6cad627", "type": "Rich Text", "label": "Content"},
        ],
    ...
    expected_types: typing.Any = {
        ...
        "properties": (
            "list",
            {
                0: {"propertyId": None, "type": None, "label": None},
                1: {"propertyId": None, "type": None, "label": None},
            },
        ),
        "pagination": {"limit": None, "offset": None, "total": None},
    }

...
async def test_delete(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    assert client.webhooks.delete(webhook_id="580e64008c9a982ac9b8b754") is None  # type: ignore[func-returns-value]

    assert await async_client.webhooks.delete(webhook_id="580e64008c9a982ac9b8b754") is None  # type: ignore[func-returns-value]

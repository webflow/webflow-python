...
async def test_delete_custom_code(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    assert client.sites.scripts.delete_custom_code(site_id="580e63e98c9a982ac9b8b741") is None  # type: ignore[func-returns-value]

    assert await async_client.sites.scripts.delete_custom_code(site_id="580e63e98c9a982ac9b8b741") is None  # type: ignore[func-returns-value]

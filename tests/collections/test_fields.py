...
async def test_delete(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    assert client.collections.fields.delete(collection_id="580e63fc8c9a982ac9b8b745", field_id="580e63fc8c9a982ac9b8b745") is None  # type: ignore[func-returns-value]

    assert await async_client.collections.fields.delete(collection_id="580e63fc8c9a982ac9b8b745", field_id="580e63fc8c9a982ac9b8b745") is None  # type: ignore[func-returns-value]

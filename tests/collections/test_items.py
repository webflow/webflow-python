...
async def test_delete_items(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    assert client.collections.items.delete_items(collection_id="580e63fc8c9a982ac9b8b745") is None  # type: ignore[func-returns-value]

    assert await async_client.collections.items.delete_items(collection_id="580e63fc8c9a982ac9b8b745") is None  # type: ignore[func-returns-value]
...
async def test_delete_items_live(client: Webflow, async_client: AsyncWebflow) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert client.collections.items.delete_items_live(collection_id="580e63fc8c9a982ac9b8b745") is None  # type: ignore[func-returns-value]

    assert await async_client.collections.items.delete_items_live(collection_id="580e63fc8c9a982ac9b8b745") is None  # type: ignore[func-returns-value]
...
async def test_create_items(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.collections.items.create_items(
        ...
        is_archived=False,
        is_draft=False,
        field_data=CreateBulkCollectionItemRequestBodyFieldDataName(name="Don’t Panic", slug="dont-panic"),
    )
    validate_response(response, expected_response, expected_types)
...
async def test_delete_item(client: Webflow, async_client: AsyncWebflow) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert client.collections.items.delete_item(collection_id="580e63fc8c9a982ac9b8b745", item_id="580e64008c9a982ac9b8b754") is None  # type: ignore[func-returns-value]

    assert await async_client.collections.items.delete_item(collection_id="580e63fc8c9a982ac9b8b745", item_id="580e64008c9a982ac9b8b754") is None  # type: ignore[func-returns-value]
...
async def test_delete_item_live(client: Webflow, async_client: AsyncWebflow) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert client.collections.items.delete_item_live(collection_id="580e63fc8c9a982ac9b8b745", item_id="580e64008c9a982ac9b8b754") is None  # type: ignore[func-returns-value]

    assert await async_client.collections.items.delete_item_live(collection_id="580e63fc8c9a982ac9b8b745", item_id="580e64008c9a982ac9b8b754") is None  # type: ignore[func-returns-value]

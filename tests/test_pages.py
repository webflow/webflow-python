...
async def test_list_(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.pages.list(
        site_id="580e63e98c9a982ac9b8b741", locale_id="65427cf400e02b306eaa04a0", limit=1.1, offset=1.1
    )
...
async def test_get_content(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    response = client.pages.get_content(
        page_id="63c720f9347c2139b248e552", locale_id="65427cf400e02b306eaa04a0", limit=1.1, offset=1.1
    )
    validate_response(response, expected_response, expected_types)

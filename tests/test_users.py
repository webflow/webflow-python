...
async def test_delete(client: Webflow, async_client: AsyncWebflow) -> None:
    ...
    assert client.users.delete(site_id="580e63e98c9a982ac9b8b741", user_id="580e63e98c9a982ac9b8b741") is None  # type: ignore[func-returns-value]

    assert await async_client.users.delete(site_id="580e63e98c9a982ac9b8b741", user_id="580e63e98c9a982ac9b8b741") is None  # type: ignore[func-returns-value]

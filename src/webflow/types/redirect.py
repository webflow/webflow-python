...
class Redirect(pydantic_v1.BaseModel):
    """
    ...
    from_url: typing.Optional[str] = pydantic_v1.Field(alias="fromUrl", default=None)
    """
    The source URL path that will be redirected.
    """

    to_url: typing.Optional[str] = pydantic_v1.Field(alias="toUrl", default=None)
    """

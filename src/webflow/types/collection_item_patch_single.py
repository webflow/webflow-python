...
class CollectionItemPatchSingle(pydantic_v1.BaseModel):
    """
    ...
    field_data: typing.Optional[CollectionItemPatchSingleFieldData] = pydantic_v1.Field(alias="fieldData", default=None)

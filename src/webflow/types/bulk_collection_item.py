...
class BulkCollectionItem(pydantic_v1.BaseModel):
    """
    ...
    cms_locale_ids: typing.Optional[typing.List[str]] = pydantic_v1.Field(alias="cmsLocaleIds", default=None)
    """
    ...
    field_data: typing.Optional[BulkCollectionItemFieldData] = pydantic_v1.Field(alias="fieldData", default=None)

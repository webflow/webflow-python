...
class PageDetails(pydantic_v1.BaseModel):
    """
    The Page object
    """
    ...
    seo: typing.Optional[PageDetailsSeo] = pydantic_v1.Field(default=None)
    """
    SEO-related fields for the Page
    """

    open_graph: typing.Optional[PageDetailsOpenGraph] = pydantic_v1.Field(alias="openGraph", default=None)
    """

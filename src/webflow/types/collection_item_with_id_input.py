...
class CollectionItemWithIdInput(pydantic_v1.BaseModel):
    """
    ...
    field_data: typing.Optional[CollectionItemWithIdInputFieldData] = pydantic_v1.Field(alias="fieldData", default=None)

...
from .resources.site_plan.client import SitePlanClient
...
from .resources.site_plan.client import AsyncSitePlanClient
...
class Webflow:
    ...
    def __init__(
        ...
        *,
        ...
        self.site_plan = SitePlanClient(client_wrapper=self._client_wrapper)
...
class AsyncWebflow:
    ...
    def __init__(
        ...
        *,
        ...
        self.site_plan = AsyncSitePlanClient(client_wrapper=self._client_wrapper)

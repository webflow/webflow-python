...
from .resources.well_known.client import WellKnownClient
...
class SitesClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        ...
        self.well_known = WellKnownClient(client_wrapper=self._client_wrapper)
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                ...
                sites_list = response_json.get("sites", [])
                return typing.cast(
                    List[Site],
                    parse_obj_as(
                        type_=List[Site],  # type: ignore
                        object_=sites_list,
                    ),
                )
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> List[Site]:
        """
...
class AsyncSitesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        ...
        self.well_known = AsyncWellKnownClient(client_wrapper=self._client_wrapper)

...
class SitesPublishResponse(pydantic_v1.BaseModel):
    ...
    publish_to_webflow_subdomain: typing.Optional[bool] = pydantic_v1.Field(
        alias="publishToWebflowSubdomain", default=None
    )
    """

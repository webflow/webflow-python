...
class TokenClient:
    ...
    def authorized_by(self) -> AuthorizedUser:
        """
    ...
    def introspect(self) -> Authorization:
        """
...
class AsyncTokenClient:
    ...
    async def authorized_by(self) -> AuthorizedUser:
        """
        Information about the Authorized User <br><br> Required Scope | `authorized_user:read`
    ...
    async def introspect(self) -> Authorization:
        """
        Information about the authorization token

        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return pydantic_v1.parse_obj_as(UserList, _response.json())  # type: ignore
    ...
    def update(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"sites/{jsonable_encoder(site_id)}/users/{jsonable_encoder(user_id)}",
            method="PATCH",
            json={"data": data, "accessGroups": access_groups},
            request_options=request_options,
            omit=OMIT,
        )
        try:
    ...
    def invite(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"email": email, "accessGroups": access_groups},
            request_options=request_options,
            omit=OMIT,
        )
        try:

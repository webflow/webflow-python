...
_dynamic_imports: typing.Dict[str, str] = {
    "AnalyzeBucketTimeZone": ".types",
    "AnalyzeDailyBucketing": ".types",
    "AnalyzeDailyTimeseriesQuery": ".types",
    "AnalyzeFilterOperators": ".types",
    "AnalyzeTimeOnPageBucketing": ".types",
    "AnalyzeWindow": ".types",
    "Application": ".types",
    "Asset": ".types",
    "AssetFolder": ".types",
    ...
    "BranchCreatedWebhook": ".types",
    "BranchCreatedWebhookPayload": ".types",
    "BranchDeletedWebhook": ".types",
    "BranchDeletedWebhookPayload": ".types",
    "BranchMergedWebhook": ".types",
    "BranchMergedWebhookPayload": ".types",
    ...
    "CustomFontBatchCreateRequestItemsItem": ".resources",
    "CustomFontBatchCreateRequestItemsItemFontDisplay": ".resources",
    "CustomFontBatchCreateResponse": ".types",
    "CustomFontBatchCreateResponseCreatedItem": ".types",
    "CustomFontBatchCreateResponseFailedItem": ".types",
    ...
    "InsertCollectionItem": ".types",
    "InsertCollectionItemFieldData": ".types",
    "InsertedCollectionItem": ".types",
    "InsertedCollectionItemFieldData": ".types",
    ...
    "TextNodeText": ".types",
    "TextNodeWrite": ".types",
    "TimeOnPageDataPoint": ".types",
    "TimeOnPageFilter": ".types",
    "TimeOnPageGranularityPeriod": ".types",
    "TimeOnPageMetricScope": ".types",
    "TimeOnPageResponse": ".types",
    "TimeOnPageTimeseriesQuery": ".types",
    "TooManyRequestsError": ".errors",
    "TopDimensionsDimension": ".types",
    "TopDimensionsFilter": ".types",
    "TopDimensionsMetricScope": ".types",
    "TopDimensionsResponse": ".types",
    "TopDimensionsRow": ".types",
    "TopEventsCmsContextEntry": ".types",
    "TopEventsComponentContextEntry": ".types",
    "TopEventsFilter": ".types",
    "TopEventsResponse": ".types",
    "TopEventsRow": ".types",
    "TopEventsTimeseriesPoint": ".types",
    "TopPagesFilter": ".types",
    "TopPagesResponse": ".types",
    "TopPagesRow": ".types",
    "TopPagesSortBy": ".types",
    "TopPagesTimeseriesPoint": ".types",
    "TrafficDataPoint": ".types",
    "TrafficFilter": ".types",
    "TrafficMetricScope": ".types",
    "TrafficResponse": ".types",
    "TriggerType": ".types",
